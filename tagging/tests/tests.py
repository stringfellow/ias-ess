...
## This flag is added here to turn off all tests that use join filters, because
## these kinds of object filters are not supported by django-nonrel.
EXCLUDE_JOIN_TESTS = True

## This flag is added here to turn off tests that use exclude filters that GAE can't handle 
